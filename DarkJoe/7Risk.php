<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // 預備和綁定
        $stmt = $conn->prepare("INSERT INTO test (公司名稱, 公司統編) VALUES (?, ?)");
        $stmt->bind_param("ss", $companyName, $companyID);
            ...
            <div class="row">
                ...
                <div class="col-xs-8">
                    <div class="content"><a data-scroll href="#body" class="logo-text"
                            style="font-family:sans-serif; font-size: 30px;text-align: center; display: flex; flex-direction: initial;align-items: baseline; justify-content: center;">財務與市場<br>風險評估系統</a>
                    </div>
                </div>
                <div class="col-xs-2">
                    <div class="nav">
                        ...
                        <div class="dropdown-menu" style="background: #5b5b59;">
                            ...
                            <ul>
                                ...
                                <a href="Risk_Assessment-search.html">
    ...
    <section id="services" class="service-area">
        <div class="container">
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                ...
                <div class="row">
                    ...
                    <div class="col-12 input-group mb-3 ">
                        <input type="text" class="form-control" name="companyName"placeholder="輸入公司全稱" id="Company_Name">
                    </div>


                    <div class="col-12 input-group mb-3">
                        <input type="number" class="form-control"name="companyID" placeholder="輸入統一編號" id="Uniform_numbers">
                    </div>
                    <div class="col-12  text-center">
                        <button class="test" type="submit" onclick="validateForm()">查詢</button>
                    </div>
            ...
            <p class="aa">
                ...
                務必多元化您的投資組合，將您的資金分散投入多個資產類別或市場，以減輕單一資產或市場波動所帶來的衝擊。定期監控和重新評估您的投資，以確保它們仍然符合您的長期財務目標。記住，投資不是一場速成致富的競賽，而是一場長期的旅程。

                在此過程中，謹記選擇明智且審慎的投資，並保持耐心，這將有助於您實現長期財務成功。不要被瞬間的市場波動或短期的風險擾亂您的目標，堅定地秉持著長期視野，這是實現財務穩健和成功的關鍵。</p>
        </div>
