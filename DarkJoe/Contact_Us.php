...
<body id="body" onload="init()">
    ...
    <section id="navigation">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-8">
                    <div class="content"><a data-scroll href="#body" class="logo-text" style="font-family:sans-serif; font-size: 30px;text-align: center; display: flex; flex-direction: initial;align-items: baseline; justify-content: center;">
                            市場風險<br>評估系統</a>
                    </div>
                </div>
                <div class="col-xs-2">
    ...
    <section id="contact" class="mapWrap">
        <div id="contact-area" style="background-color: #ffff;">
            <div class="container">
                <h2 class="block_title" style="color: #000000;">你好</h2>
                <div class="col-sm-12">
                    <h1 class="con-title">與我們聯繫</h1>
                    <form action="show.php" role="form" method="post" enctype="text/plain">
                        ...
                        <button type="submit" class="btn medium " style="color: #000; border: #000 solid 1px;">讓我們知道</button>
                    </form>
                </div>
            </div>
        </div><!-- container -->
